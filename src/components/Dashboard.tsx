...
interface Stats {
    ...
    topLanguages: { language: string; count: number; size: number }[];
}
                ...
                <div className="charts-row">
                    ...
                    <div className="glass-card chart-card ai-insight-card">
                        ...
                        <p className="ai-insight-text">
                            {insight || `Based on your recent activity, you are highly active in ${stats?.topLanguages[0]?.language ?? "multiple languages"}. Your code consistency has increased by 15% this month.`}
                        </p>
                    </div>
                </div>
